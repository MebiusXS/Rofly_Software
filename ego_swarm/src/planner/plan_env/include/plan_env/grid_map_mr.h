...
private:
  ...
  ros::Subscriber indep_cloud_sub_, indep_odom_sub_, extrinsic_sub_, lidar_cloud_sub_;
...
//   return int(md_.occupancy_buffer_inflate_[globalIdx2InfBufIdx(pos2GlobalIdx(pos))] >=1 );
// }
