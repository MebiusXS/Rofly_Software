...
namespace ego_planner
{
      ...
      int id_cps_end, PtsChk_t &pts_check)
  {
    ...
    // std::cout << "PolyTrajOptimizer::computePointsToCheck max_vel = " << max_vel_ << std::endl;
                                               ...
                                               double &costv)
  {
    ...
    // std::cout << "PolyTrajOptimizer::feasibilityGradCostV max_vel = " << max_vel_ << std::endl;
    if (vpen > 0)
    {
                                               ...
                                               double &costa)
  {
    ...
    // std::cout << "PolyTrajOptimizer::feasibilityGradCostA max_acc = " << max_acc_ << std::endl;
    if (apen > 0)
    {
  ...
  void PolyTrajOptimizer::set_vel_acc(const double temp[2])
  {
    max_vel_ = temp[0];
    max_acc_ = temp[1];
  }
