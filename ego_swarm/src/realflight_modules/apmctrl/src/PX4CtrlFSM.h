...
struct AutoTakeoffLand_t
{
	...
	static constexpr double ARM_ALLOWED_VEL = 0.16; // allowd non-static velocity when try to arm.
...
private:
	...
	bool check_nonstatic_vel_on_ground(const Odom_Data_t &odom, const double allowd_vel);
