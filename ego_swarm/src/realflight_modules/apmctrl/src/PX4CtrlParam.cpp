...
{	
	// Modified:
	bool my_print_value;
	if (ros::param::has("/my_print_value")) {
		ros::param::get("/my_print_value", my_print_value);
		ros::param::set("/px4ctrl/thrust_model/print_value", my_print_value);
	}
	double my_hover_percentage;
	if (ros::param::has("/my_hover_percentage")) {
		ros::param::get("/my_hover_percentage", my_hover_percentage);
		ros::param::set("/px4ctrl/thrust_model/hover_percentage", my_hover_percentage);
	}
