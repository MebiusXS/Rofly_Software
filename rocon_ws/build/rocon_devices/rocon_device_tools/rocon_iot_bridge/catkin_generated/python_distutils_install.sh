...
echo_and_run cd "/home/fast/rocon_ws/src/rocon_devices/rocon_device_tools/rocon_iot_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/fast/rocon_ws/src/rocon_devices/rocon_device_tools/rocon_iot_bridge/setup.py" \
     \
    build --build-base "/home/fast/rocon_ws/build/rocon_devices/rocon_device_tools/rocon_iot_bridge" \
    install \
    --root="${DESTDIR-/}" \
